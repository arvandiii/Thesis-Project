...
def clean_text(text):
    ...
    # Replace links with the word "link"
...
print(clean_text('and Livestock... https://t.co/mB9FUqYzXx via @StandardB'))

def is_text_english(text):
    print(not any(char not in '0123456789abcdefghijklmnopqrstuvwxyz .!?@#$%^&*()-=_,:;\'\"' for char in str(text)), text)
    return not any(char not in '0123456789abcdefghijklmnopqrstuvwxyz .!?@#$%^&*()-=_,:;\'\"' for char in str(text))